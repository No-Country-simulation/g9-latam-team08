...
export default function Historial() {
  ...
  const itemsPerPage = 5; // cambiar esto a 10 o 20 según que se busca
...
const response = await fetch(
  ...
  return (
    <div style={{ padding: 'clamp(1rem, 5vw, 2rem)', maxWidth: '1100px', margin: '0 auto' }}>

      <header style={{ marginBottom: '2rem' }}>
        <h1 style={{ fontSize: '2rem', margin: '0 0 0.5rem 0', color: 'var(--color-text)' }}>Historial Financiero</h1>
