...
// TEMP-FE:
// Resultado simulado para habilitar el Happy Path
// mientras Backend/Data Science terminan el contrato real.
...
const buildCategorySummaries = (
  ...
  const grouped = new Map<
    string,
    { amount: number; transactionsCount: number }
  >();
...
export const buildMockAnalysisResult = (
  ...
  // TEMP-FE:
  // Estimación mensual basada en el período cargado.
  // Backend/Data Science definirán el indicador definitivo.
