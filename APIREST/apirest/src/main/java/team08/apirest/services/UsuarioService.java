...
public class UsuarioService{
    ...
    // GENERAR ANALISIS EN BASE A DATOS ENVIADOS
    public UsuarioModel generarAnalisisFinanciero(UsuarioModel usuario) {
        RestTemplate restTemplate = new RestTemplate();
        try {
            return restTemplate.postForObject(PYTHON_SERVICE_URL, usuario, UsuarioModel.class);
        } catch (Exception e) {
            System.err.println("Error al generar analisis: " + e.getMessage());
            return null;
        }
}
}
